...
function get_household_data($apikey,$id)
{
    ...
    $json = file_get_contents("http://localhost/emoncms/feed/average.json?id=$id&start=$startms&end=$endms&interval=$interval&skipmissing=0&limitinterval=0&apikey=$apikey");
