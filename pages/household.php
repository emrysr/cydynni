<div class="page" page="household" style="display:none">
  ...
  <div class="pagesection" style="color:rgb(41,171,226)">
    ...
    <div class="title"><?php echo t("Realtime");?></div>
  ...
  <div class="panel" style="color:rgb(41,171,226)">
    <div class="panel-inner">
      ...
      <div id="household-status-block">
          <div style="font-size:24px; font-weight:bold">POWER NOW:</div>
          <div style="font-size:108px; font-weight:bold"><span id="realtime-power">---</span>W</div>
      </div>
